...
class Search_thai_Crawler:
    ...
    def get_thai_article(self,page):
        Headline = page.find('span', 'jsx-2430232205 jsx-3959658973 text-color-news').text
        Link = page.find('a').get('href')
        Posted = page.find('time').get('datetime')
        Description = page.find('p', 'jsx-2430232205 jsx-3959658973 description').text

        article = (Headline,Posted,Link,Description)
        return article
